        ...
        <section className="pt-40 pb-20 px-4 md:px-8 relative overflow-hidden bg-slate-900 text-white">
            ...
            <div className="max-w-7xl mx-auto text-center relative z-10">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-white bg-clip-text bg-gradient-to-r from-white to-slate-400 leading-tight">
                        Kontaktieren Sie uns
                    </h1>
                    <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed font-light">
                        Wir freuen uns darauf, von Ihrem Unternehmen zu hören.
                    </p>
                </motion.div>
            </div>
        </section>

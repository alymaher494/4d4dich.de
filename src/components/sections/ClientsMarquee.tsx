...
const staticRow2 = [
    { id: "6", name: "Toirov Pflege", logo: "/images/assets/ba251e3c999727a212612fbe3521d09f.png" },
    { id: "7", name: "Altahan Baureinigung", logo: "/images/assets/fd9f905da9482a90e74011b3d138f0aa.png" },
    { id: "8", name: "Sauberbienen", logo: "/images/assets/3207de4b43cb61a8c4841ea471959dec.png" },
    { id: "9", name: "MT24 Sicherheit", logo: "/images/assets/5b8be49aa064b0ffd9afd90169066532.png" },
    { id: "10", name: "Hausarzt Schwerte", logo: "/images/assets/87c1916c29327ffb94f15bfd959b8b65.png" },
];
...
export default function ClientsMarquee({ initialClients = [] }: ClientsMarqueeProps) {
    // Map and split clients into two rows
    const wpClients = initialClients.map(client => ({
        id: client.id.toString(),
        name: client.title.rendered,
        logo: getFeaturedImageUrl(client) || "/images/assets/ba251e3c999727a212612fbe3521d09f.png"
    }));

    let row1 = wpClients.slice(0, Math.ceil(wpClients.length / 2));
    let row2 = wpClients.slice(Math.ceil(wpClients.length / 2));

    // Fallback if no WP data

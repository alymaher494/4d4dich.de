                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8">
                    {grafikDesignContent.why_us.reasons.map((reason, idx) => (
                        <div key={idx} className="p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-sm text-center space-y-4 group hover:bg-white/10 transition-colors">
                            <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center mx-auto text-secondary transition-all duration-300 group-hover:bg-primary group-hover:text-white group-hover:scale-110 shadow-lg shadow-white/5">

...
import { PenTool, Layers, Image as ImageIcon, MousePointer2, Smartphone, Palette, Megaphone, Video, Sparkles } from "lucide-react";
                ...
                <div className="space-y-8 order-2 lg:order-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {grafikDesignContent.services.map((service, idx) => {
                            const Icon = [PenTool, Smartphone, Palette, Megaphone, Video, Sparkles][idx] || LogoIcon;
                            return (
                                <motion.div
                                    key={idx}

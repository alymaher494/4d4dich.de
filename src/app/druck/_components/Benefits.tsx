...
export default function DruckBenefits({ acf }: BenefitsProps) {
    const title = acf?.benefits_title || druckContent.whatsapp_advantages.title;
    const features = acf?.benefits_description
        ? acf.benefits_description.split('\n').filter((item: string) => item.trim() !== '')
        : druckContent.whatsapp_advantages.features;
